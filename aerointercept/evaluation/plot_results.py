...
用法:
  python -m aerointercept.evaluation.plot_results \\
      --csv artifacts/runs/experiments/png/evaluation.csv artifacts/runs/experiments/legacy_bc/evaluation.csv artifacts/runs/experiments/legacy_ppo/evaluation.csv \\
      --labels PNG BC RL --out artifacts/runs/experiments/comparison/plots
"""
import argparse
import csv
import os
...
def main():
    ...
    parser.add_argument("--out", default="artifacts/runs/experiments/comparison/plots")
